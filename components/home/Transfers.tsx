    ...
    >
      <div className={styles.container}>
        ...
        <div className={styles.allTransfersWrap}>
          <Link
            href="/prestupy"
            className={styles.allTransfersButton}
          >
            <span>
              VŠECHNY PŘESTUPY
            </span>
...
function TransferEmptyCard({
  ...
  return (
    <article
      className={`${styles.transferCard} ${styles.emptyCard} ${
        arrival
          ? styles.cardArrival
          : styles.cardDeparture
      }`}
    >
      ...
      <div className={styles.emptyBody}>
        ...
        <span>
          {arrival
            ? "Nový příchod se zobrazí zde."
            : "Další odchod se zobrazí zde."}
        </span>
      </div>
    </article>
  );
...
function buildPlayerUrl(
  ...
  return `https://futsalvplzni.cz/hrac/${playerId}/${slug}`;
}

function buildApfPlayerSlug(
  playerName: string,
): string {
  const parts =
    playerName
